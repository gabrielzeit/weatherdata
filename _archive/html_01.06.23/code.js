...
function time_span_klimaanalyse_span(startdate, enddate, data) {
    ...
    console.log(myAnalyseChart.data)

        // HIER NOCH DATE UND TIME RAUSWERFEN/SKIPPEN
...
//                myAnalyseChart.data.datasets[p].data = daten[p]
//                myAnalyseChart.data.datasets[p].label = processData[0][p]
            }
        }
    }
//    for(let x = 0; x < myAnalyseChart.data.datasets.length; x++){
//        if(myAnalyseChart.data.datasets[x].label == "date" || myAnalyseChart.data.datasets[x].label == "timehhmmss"){
//            delete myAnalyseChart.data.datasets[x]
//        }
//    }
    console.log(myAnalyseChart.data)
